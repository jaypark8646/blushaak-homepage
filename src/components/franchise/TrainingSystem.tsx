...
const EDUCATION_CARDS = [
  {
    title: "전담 바이저 밀착 케어",
    description:
      "개별 슈퍼바이저가 담당 매장을 주기적으로 방문하여 1:1 맞춤 교육을 진행합니다. 오픈 전부터 안정화까지 전 과정에 걸친 밀착 관리로 점주님의 성공적인 운영을 지원합니다.",
  },
  {
    title: "위생 및 교육 시스템",
    description:
      "정기적인 위생 점검 및 교육 프로그램을 통해 매장 청결도와 서비스 품질을 균일하게 유지합니다. QC(품질관리) 시스템과 연계하여 체계적인 관리가 이루어집니다.",
  },
];
