...
export const COST_TABLE: CostItem[] = [
  ...
  },
  {
    ...
    cost10: "25,000,000",
    cost15: "37,500,000",
    note: "10평 기준 2,500만원이며, 매장 실측 및 점포 상황에 따라 최종 금액은 달라질 수 있습니다.",
  },
  {
    category: "전기증설/에어컨",
    cost10: "-",
  ...
  },
  {
    ...
    cost10: "25,700,000",
    cost15: "25,700,000",
    note: "커피머신 지원 적용 · 오븐기/비닝 쇼케이스/그라인더 3대 포함",
  },
  {
    category: "초도비품",
    cost10: "3,200,000",
...
export const GLOBAL_LOCATIONS: GlobalLocation[] = [
  {
    ...
    description:
      "인도네시아의 대표적인 랜드마크이자 핵심 상권인 자카르타 센트럴 파크몰(Central Park Mall)에 성공적으로 진출하며 글로벌 시장에 이름을 알리고 현지 고객들의 폭발적 반응에 힘입어 자카르타 1호점의 성공적 런칭을 기록하였습니다.",
    lat: -6.1751,
    lng: 106.79,
  },
  {
